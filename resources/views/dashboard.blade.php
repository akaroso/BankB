                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="p-8 bg-white border-b ">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <class="underline text-gray-900 dark:text-white>Balance: @money(Auth::user()->Account->balance)$</a> 
                            </div>
                        </div>
                            ...
                            <table class="min-w-full bg-white ">
                                ...
                                <tbody class="text-gray-700">
                                    ...
                                    <tr class={{$rowclass}}>
                                        ...
                                        <td class="text-left py-3 px-4"><a class="hover:text-blue-500" href="mailto:jonsmith@mail.com">@money($opt->amount)$</a></td>
                                    </tr>
